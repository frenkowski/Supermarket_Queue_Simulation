var CanvasModule = function(canvas_width, canvas_height, grid_width, grid_height, terrain_map_name) {
	// Create the element
	// ------------------
	...
	var terrainDraw = new TerrainGenerator(canvas_width, canvas_height, grid_width, grid_height, context, terrain_map_name);
